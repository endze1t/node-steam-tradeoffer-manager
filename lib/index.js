 ...
 * @param callback
 */
TradeOfferManager.prototype.getUserInventoryContents = function(partner, token, appid, contextid, tradableOnly, callback) {
	this._community.getTradePartnerInventory(partner, token, appid, contextid, callback);
};
